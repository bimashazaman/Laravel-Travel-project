                ...
                <div>
                    <div
                        ...
                        <div class="list-group list-group-light">
                            ...
                            <button type="button" class="list-group-item list-group-item-action px-3 border-0">
                                Dapibus ac facilisis in <a href="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="red"
                                    class="bi bi-trash" viewBox="0 0 16 16">
                                    <path
                                        d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z" />
                            ...
                            <button type="button" class="list-group-item list-group-item-action px-3 border-0">
                                Porta ac consectetur ac <a href="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="red"
                                    class="bi bi-trash" viewBox="0 0 16 16">
                                    <path
                                        d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z" />
            ...
            <div>
                <div
                    ...
                    <div class="list-group list-group-light ">
                        <button type="button" class="list-group-item list-group-item-action  px-3 border-0  "
                            aria-current="true">
                            Cras justo odio <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
