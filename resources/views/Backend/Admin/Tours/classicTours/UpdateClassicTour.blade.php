                ...
                <div class="card-body" style="box-shadow: rgba(14, 30, 37, 0.12) 0px 2px 4px 0px, rgba(14, 30, 37, 0.32) 0px 2px 16px 0px;">
                    <form id="tourForm" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input style="box-shadow: rgba(17, 17, 26, 0.1) 0px 0px 16px;" type="text" class="form-control" name="name" value="{{$tour->name}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-md-2">Description</label>
                            <div class="col-md-10">
                                <textarea style="box-shadow: rgba(17, 17, 26, 0.1) 0px 0px 16px; width:100%; border:none" name="description" cols="30" rows="10">{{$tour->description}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-md-2">Duration</label>
                            <div class="col-md-10">
                                <input style="box-shadow: rgba(17, 17, 26, 0.1) 0px 0px 16px;" type="text" class="form-control" name="duration" value="{{$tour->duration}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-md-2">Price</label>
                            <div class="col-md-10">
                                <input style="box-shadow: rgba(17, 17, 26, 0.1) 0px 0px 16px;" type="number" class="form-control" name="price" value="{{$tour->price}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            {{$tour->check}}
                            <!-- <div class="col-md-10">
                                    <input style="box-shadow: rgba(17, 17, 26, 0.1) 0px 0px 16px;" type="date" class="form-control" name="start_date" value="{{$tour->start_date}}">
                                </div> -->
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-md-2">End Date</label>
                            <div class="col-md-10">
                                <input style="box-shadow: rgba(17, 17, 26, 0.1) 0px 0px 16px;" type="date" class="form-control" name="end_date" value="{{$tour->end_date}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control form-select" name="category_id" value="{{$tour->category_id}}">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-md-2">Default Select</label>
                            <div class="col-md-10">
                                <select class="form-control form-select" name="destination_id" value="{{$tour->destination_id}}">
                                    <option>-- Select --</option>
