...
<div class="page-header">
    <div class="row">
        <div class="col-sm-12">
            <h2 class="page-title" style="text-align: center">Create Related places to Do</h2>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="card" style="box-shadow: rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px;">
            ...
            <div class="card-body">
                <form id="tourForm" action="/admin/addRelatedDo/{{ $see->id }}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="font-weight-600 text-danger float-end" style="display: flex">
                                                ...
                                                <span>
                                                    <a href="{{ url('/admin/thingsToDo/edit/' . $t->id) }}">
                                                        <button type="button"
                                                ...
                                                <form method="POST"
                                                    action="{{ url('/admin/thingsToDo/delete/' . $t->id) }}">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
