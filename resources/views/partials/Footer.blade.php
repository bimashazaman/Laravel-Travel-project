    ...
    <footer style="width: 95%;display: flow-root;margin-left: 6%;">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-sm-3 col-md-2 item">
                  ...
                  <div class="col-sm-5 col-md-4 item" style="display: flex">
                    
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="233" height="167" viewBox="0 0 233 167">
                        <defs>
                          <filter id="Rectangle_478" x="84" y="29" width="66" height="66" filterUnits="userSpaceOnUse">
                          ...
                          <filter id="Rectangle_479" x="0" y="101" width="66" height="66" filterUnits="userSpaceOnUse">
                            <feOffset dy="3" input="SourceAlpha"/>
                          ...
                          <filter id="Rectangle_480" x="167" y="101" width="66" height="66" filterUnits="userSpaceOnUse">
                            <feOffset dy="3" input="SourceAlpha"/>
                          ...
                          <filter id="Rectangle_481" x="167" y="29" width="66" height="66" filterUnits="userSpaceOnUse">
                            <feOffset dy="3" input="SourceAlpha"/>
                          ...
                          <filter id="Rectangle_482" x="84" y="101" width="66" height="66" filterUnits="userSpaceOnUse">
                            <feOffset dy="3" input="SourceAlpha"/>
                          ...
                          <filter id="Rectangle_483" x="0" y="29" width="66" height="66" filterUnits="userSpaceOnUse">
                            <feOffset dy="3" input="SourceAlpha"/>
                        ...
                        <g id="Group_605" data-name="Group 605" transform="translate(9.199)">
                          <g id="Group_485" data-name="Group 485" transform="translate(0)">
                            <g id="Group_424" data-name="Group 424">
                              <text id="Follow_us" data-name="Follow us" transform="translate(54.801 22)" fill="#f1e6be" font-size="24" font-family="Arial-BoldItalicMT, Arial" font-weight="700" font-style="italic"><tspan x="-55" y="0">Follow us</tspan></text>
                            </g>
                          </g>
                          <g id="Group_597" data-name="Group 597" transform="translate(84 35)">
                            <g transform="matrix(1, 0, 0, 1, -93.2, -35)" filter="url(#Rectangle_478)">
                              <rect id="Rectangle_478-2" data-name="Rectangle 478" width="48" height="48" rx="8" transform="translate(93 35)" fill="#284525"/>
                            </g>
                            <path id="Icon_feather-facebook" data-name="Icon feather-facebook" d="M27,3H22.5A7.5,7.5,0,0,0,15,10.5V15H10.5v6H15V33h6V21h4.5L27,15H21V10.5A1.5,1.5,0,0,1,22.5,9H27Z" transform="translate(5 6.5)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"/>
                          </g>
                          <g id="Group_602" data-name="Group 602" transform="translate(0 107)">
                            <g transform="matrix(1, 0, 0, 1, -9.2, -107)" filter="url(#Rectangle_479)">
                              <rect id="Rectangle_479-2" data-name="Rectangle 479" width="48" height="48" rx="8" transform="translate(9 107)" fill="#284525"/>
                            </g>
                          ...
                          <g id="Group_601" data-name="Group 601" transform="translate(167 107)">
                            <g transform="matrix(1, 0, 0, 1, -176.2, -107)" filter="url(#Rectangle_480)">
                              <rect id="Rectangle_480-2" data-name="Rectangle 480" width="48" height="48" rx="8" transform="translate(176 107)" fill="#284525"/>
                            </g>
                          ...
                          <g id="Group_600" data-name="Group 600" transform="translate(167 35)">
                            <g transform="matrix(1, 0, 0, 1, -176.2, -35)" filter="url(#Rectangle_481)">
                              <rect id="Rectangle_481-2" data-name="Rectangle 481" width="48" height="48" rx="8" transform="translate(176 35)" fill="#284525"/>
                            </g>
                          ...
                          <g id="Group_599" data-name="Group 599" transform="translate(84 107)">
                            <g transform="matrix(1, 0, 0, 1, -93.2, -107)" filter="url(#Rectangle_482)">
                              <rect id="Rectangle_482-2" data-name="Rectangle 482" width="48" height="48" rx="8" transform="translate(93 107)" fill="#284525"/>
                            </g>
                          ...
                          <g id="Group_596" data-name="Group 596" transform="translate(0 35)">
                            <g transform="matrix(1, 0, 0, 1, -9.2, -35)" filter="url(#Rectangle_483)">
                              <rect id="Rectangle_483-2" data-name="Rectangle 483" width="48" height="48" rx="8" transform="translate(9 35)" fill="#284525"/>
                            </g>
                    ...
                    <div style="width: 20px">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="149" height="95" viewBox="0 0 149 95">
                            <defs>
                              <filter id="Rectangle_477" x="83" y="29" width="66" height="66" filterUnits="userSpaceOnUse">
                                <feOffset dy="3" input="SourceAlpha"/>
                                <feGaussianBlur stdDeviation="3" result="blur"/>
                                <feFlood/>
                                <feComposite operator="in" in2="blur"/>
                              ...
                              <filter id="Rectangle_476" x="0" y="29" width="66" height="66" filterUnits="userSpaceOnUse">
                                <feOffset dy="3" input="SourceAlpha"/>
                                <feGaussianBlur stdDeviation="3" result="blur-2"/>
                                <feFlood/>
                                <feComposite operator="in" in2="blur-2"/>
                            ...
                            <g id="Group_606" data-name="Group 606" transform="translate(-1559 -3380)">
                              <g id="Group_604" data-name="Group 604" transform="translate(1568.199 3380)">
                                <g id="Group_424" data-name="Group 424">
                                  <text id="Call_Write" data-name="Call / Write" transform="translate(61.801 22)" fill="#f1e6be" font-size="24" font-family="Arial-BoldItalicMT, Arial" font-weight="700" font-style="italic"><tspan x="-61" y="0">Call / Write</tspan></text>
                                </g>
                              </g>
                              <g id="Group_595" data-name="Group 595" transform="translate(1651.199 3415)">
                                <g transform="matrix(1, 0, 0, 1, -92.2, -35)" filter="url(#Rectangle_477)">
                                  <rect id="Rectangle_477-2" data-name="Rectangle 477" width="48" height="48" rx="8" transform="translate(92 35)" fill="#fff"/>
                                </g>
                              ...
                              <g id="Group_598" data-name="Group 598" transform="translate(1568.199 3415)">
                                <g transform="matrix(1, 0, 0, 1, -9.2, -35)" filter="url(#Rectangle_476)">
                                  <rect id="Rectangle_476-2" data-name="Rectangle 476" width="48" height="48" rx="8" transform="translate(9 35)" fill="#fff"/>
                                </g>
